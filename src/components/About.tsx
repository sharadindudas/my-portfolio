                ...
                <div className="grid gap-8 lg:gap-12 lg:grid-cols-2">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
                            Hello! I&apos;m Sharadindu, a passionate web
                            developer with a knack for crafting responsive,
                            user-centric digital experiences. With over a year
                            of hands-on experience, I&apos;ve been on an
                            exciting journey of turning complex ideas into
                        ...
                        <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
                            ...
                            for frontend magic, while I&apos;m actively
                            expanding my backend repertoire with{" "}
                            <span className="font-bold text-primary">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl mb-2">
                                Background
                            </h3>
                            <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
                                I&apos;ve done B.Tech in Computer Science &
                                Engineering, and worked with dynamic startups.
                                These experiences have sharpened my ability to
                                innovate, collaborate effectively, and tackle
