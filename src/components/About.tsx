        ...
        <div className="grid gap-8 lg:gap-12 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
              Hello! I&apos;m Sharadindu, a passionate web developer with a knack for crafting responsive, user-centric digital experiences. With over
              a year of hands-on experience, I&apos;ve been on an exciting journey of turning complex ideas into sleek, high-performing web
              applications.
            </p>
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
              My toolkit includes <span className="font-bold text-primary">Next.js, TypeScript, React, and JavaScript</span> for frontend magic, while
              I&apos;m actively expanding my backend repertoire with{" "}
