...
const ProjectCard = ({ project }: ProjectCardProps) => {
  return (
    <div className="w-full max-w-107.5 cursor-pointer overflow-hidden rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
      <div
        style={{
